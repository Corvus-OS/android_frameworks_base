...
*
*/
public class NetworkTrafficDualSB extends TextView implements StatusIconDisplayable {
     ...
     *  @hide
     */
    public NetworkTrafficDualSB(Context context) {
        this(context, null);
    }
     ...
     *  @hide
     */
    public NetworkTrafficDualSB(Context context, AttributeSet attrs) {
     ...
     *  @hide
     */
    public NetworkTrafficDualSB(Context context, AttributeSet attrs, int defStyle) {
